...
import com.blog.core.valication.annotation.CompareProp;
import com.blog.core.valication.annotation.ComparePropValidator;
...
public class BeanValidationUtil {
    ...
    public static <T> Map<String,String> validationBean(T t, Class<?> group) {
        ...
        for(Field f:fields){
            if(f.getAnnotation(CompareProp.class)!=null){
                f.setAccessible(true);
                String compareProps = f.getAnnotation(CompareProp.class).propName();
