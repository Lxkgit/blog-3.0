...
public class JasyptUtils {
    ...
    /*
     * 历史密码
     * redis                           密码: ENC(o8ZdpLA+3lVokD4Xd5801OYjaJCXdtKIUqPbz8+fU8s=)
     * minio          账号: minio       密码: ENC(CTkhiHpQqIJgZOVd2MMnPYVH9IMlttfBl1o3HN9R+rE=)
     * elasticsearch  账号: elastic     密码: ENC(j3dQw+Kb0iGoyP2facAeOOCbqisES4HLP9NMuKIj/s9fXTtoOzHHXw==)
     * ftp            账号: system      密码: ENC(7IYQ8HuOR6CH6QGqWFvAmCvYDDLcfkCQwAKH4Xr8OfM=)
     * mysql          账号: root        密码: ENC(CHAMoyE8XiIijQ7z2dhetMNMdeNXZhohLXw8mQ6KniCHgGtzfGHCyg==)
     */
}
