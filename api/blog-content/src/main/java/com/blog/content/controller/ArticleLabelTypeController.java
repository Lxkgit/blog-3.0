...
public class ArticleLabelTypeController {
    ...
    public Result deleteArticleLabelTypeByIds(@Validated(value = {DeleteGroup.class}) ArticleLabelTypeVo articleLabelTypeVo) throws ServiceException {
    ...
    public Result updateArticleLabelType(@RequestBody @Validated(value = {UpdateGroup.class}) ArticleLabelTypeVo articleLabelTypeVo) throws ServiceException {
