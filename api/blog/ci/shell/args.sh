...
show_help() {
  ...
  echo ""
  echo "  微服务:"
  echo "    ./buildController.sh -e pro -p blog -n api -m blog-auth,blog-gateway"
  echo ""
  echo "  单服务:"
  echo "    ./buildController.sh -e pro -p blog -n pi"
  echo ""
  echo "  单服务 + 安装依赖:"
  echo "    ./buildController.sh -e pro -p blog -n pi -i install"
  echo ""
  echo "  Blog Web:"
  echo "    ./buildController.sh -e pro -p blog -n web"
  echo ""
  echo "  Excel Web:"
  echo "    ./buildController.sh -e pro -p excel -n web"
  echo ""
  echo "参数:"
  echo "  -e    构建环境: pro | test"
  echo "  -p    项目名称"
  echo "  -n    构建目录，例如 api | pi | web"
  echo "  -i    安装依赖: install"
