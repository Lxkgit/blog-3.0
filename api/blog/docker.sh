...
startJar() {
  ...
  docker run -d --name blog --privileged=true --restart=always --network blog_network --ip 172.18.0.13 -p 60001:60001 -p 60002:60002 -p 59991:59991 -p 60032:60032 -p 21:21 -v /opt/docker/files/logs:/opt/logs blog:3.0
}
