...
#     parser.add_argument('--path', type=str, default='/file/socket_client/python/localhost',
#                         help='WebSocket endpoint path (default: /file/socket_client/python/localhost)')
