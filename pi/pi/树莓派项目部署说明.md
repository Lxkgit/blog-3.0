...
# - images        # 存放docker镜像文件
    1. jdk
        1. docker pull --platform=linux/aarch64 openjdk:17
        2. docker save openjdk:17 -o jdk17.tar
    2. mysql
    ...
    4. redis
        1. docker pull --platform=linux/aarch64 redis:6.2.5
        2. docker save redis:6.2.5 -o redis.tar
