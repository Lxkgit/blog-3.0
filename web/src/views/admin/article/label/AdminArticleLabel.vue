      ...
      <el-table lazy :load="load" :data="articleLabelTypeList.list" style="width: 100%; height: calc(100vh - 278px);"
              ...
              <el-table :data="props.row.labelList" border stripe style="width: 93%; float: right;">
                ...
                <el-table-column fixed="right" label="操作" width="100">
                  <template #default="scope">
                    ...
                    <el-button style="margin-left: 0;" @click.native.prevent="deleteArticleLabelByIdsFun(scope.row.id)"
                      size="small" text>
        ...
        <el-table-column fixed="right" label="操作" width="100">
          <template #default="scope">
            ...
            <el-button style="margin-left: 0;" @click.native.prevent="deleteArticleLabelTypeByIdsFun(scope.row.id)"
              size="small" text>
              <MyIcon type="icon-delete" />
            </el-button>
          </template>
