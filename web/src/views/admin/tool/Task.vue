<template>
  <div>
    <el-card>
      <el-table
        @expand-change="selectTaskEntityByIdFun"
        row-key="taskCode"
        :data="baseTaskList.data"
        style="height: 80vh"
      >
        ...
        <el-table-column prop="taskName" label="任务名称" fit> </el-table-column>
        <el-table-column fixed="right" label="操作" width="100">
          <template #default="scope">
...
import { selectTaskBaseListApi, selectTaskEntityByIdApi, startTaskApi } from '@/api/file'
let { MyIcon } = icon()

let { baseTaskList, show, startTaskFun, selectTaskBaseListFun, selectTaskEntityByIdFun } = taskFn()
